...
import com.comfacesar.gestion.Gestion_categoria_noticia;
import com.comfacesar.gestion.Gestion_imagen_noticia;
import com.comfacesar.gestion.Gestion_noticia;
...
public class ModificarNoticiaActivity extends AppCompatActivity {
    ...
    private Noticia noticiaRecuperada;
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putInt("id_noticia", noticiaModificar.id_notiticia);
        outState.putString("tituloNoticia", noticiaModificar.titulo_noticia);
        outState.putString("titulo", tituloEditText.getText().toString());
        outState.putString("contenidoNoticia", noticiaModificar.contenido_noticia);
        outState.putString("contenido", contenidoEditText.getText().toString());
        outState.putString("imagen", noticiaModificar.json_imagenes);
        outState.putInt("categoriaNoticia", noticiaModificar.categoria_noticia_manual_noticia);
    ...
    protected void onRestoreInstanceState(Bundle savedInstanceState) {
        ...
        noticiaModificar = new Noticia();
        noticiaRecuperada = new Noticia();
        noticiaModificar.id_notiticia = savedInstanceState.getInt("id_noticia");
        noticiaModificar.titulo_noticia = savedInstanceState.getString("tituloNoticia");
        noticiaRecuperada.titulo_noticia = savedInstanceState.getString("titulo");
        noticiaModificar.contenido_noticia = savedInstanceState.getString("contenidoNoticia");
        noticiaRecuperada.contenido_noticia = savedInstanceState.getString("contenido");
        noticiaModificar.json_imagenes = savedInstanceState.getString("imagen");
        noticiaModificar.categoria_noticia_manual_noticia = savedInstanceState.getInt("categoriaNoticia");
        noticiaRecuperada.categoria_noticia_manual_noticia = savedInstanceState.getInt("categoria");
        Gestion_sesion gestion_sesion = new Gestion_sesion(ModificarNoticiaActivity.this);
    ...
    private void cargarDatosNoticia()
    {
        ...
        {
            tituloEditText.setText(noticiaRecuperada.titulo_noticia);
            contenidoEditText.setText(noticiaRecuperada.contenido_noticia);
        }
        else
        {
        ...
        else
        {
            ...
            else
            {
                Picasso.with(getBaseContext())
                        .load(imagen_noticia.url_imagen_noticia)
    ...
    private void llenar_categorias(String json)
    {
        ...
        if(noticiaRecuperada != null)
        {
            categoriaSpinner.setSelection(noticiaRecuperada.categoria_noticia_manual_noticia);
        }
        else
        {
            int cont = 1;
